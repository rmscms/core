<nav class="navbar fixed-bottom shadow-lg p-0 border-0 d-block d-md-none modern-navbar">
    <div class="container-fluid px-0">
        <div class="d-flex justify-content-between align-items-center w-100 position-relative">
            <x-cms::menu-item href="#" icon="ph-chart-line" label="{{ trans('auth.dashboard') }}" class="flex-fill text-center py-3">
            ...
            <x-cms::menu-item href="#" icon="ph-alarm" label="{{ trans('auth.expireds') }}" class="flex-fill text-center py-3">
                <div class="nav-icon-wrapper mb-1">
            ...
            <x-cms::menu-item href="#" icon="ph-headset" label="{{ trans('auth.tickets') }}" class="flex-fill text-center py-3 text-light">
                <div class="nav-icon-wrapper mb-1">
            ...
            <x-cms::menu-item href="#" icon="ph-currency-dollar" label="{{ trans('auth.charging_panel') }}" class="flex-fill text-center py-3 text-light">
                <div class="nav-icon-wrapper mb-1">
